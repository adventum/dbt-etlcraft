        ...
        insert into test.join_appmetrica_events_deeplinks ("__date", "__table_name", "event_datetime", "accountName", "appmetricaDeviceId", "mobileAdsId", "crmUserId", "osName", "cityName", "adSourceDirty", "utmSource", "utmMedium", "utmCampaign", "utmTerm", "utmContent", "utmHash", "__emitted_at", "__link")
  SELECT
