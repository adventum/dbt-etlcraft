  ...
  create view test.normalize_ym_default_yandex_metrika_stream__dbt_tmp 
...
JSONExtractString(_airbyte_data, 'ym:s:visitID') AS ymsvisitID,
    ...
    FROM (
        ...
        (
            select
                cast('test._airbyte_raw_ym_default_26746851_yandex_metrika_stream' as String) as _dbt_source_relation,
            ...
            from test._airbyte_raw_ym_default_26746851_yandex_metrika_stream
