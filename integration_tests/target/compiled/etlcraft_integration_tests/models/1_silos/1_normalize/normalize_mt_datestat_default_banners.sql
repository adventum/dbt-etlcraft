...
JSONExtractString(_airbyte_data, 'urls') AS urls,
    ...
    FROM (
        ...
        (
            select
                cast('test._airbyte_raw_mt_datestat_default_2222222_banners' as String) as _dbt_source_relation,
            ...
            from test._airbyte_raw_mt_datestat_default_2222222_banners
