...
- `attributable_parameters` - разбивки (поля, по которым группируются данные, например: название источника данных, название рекламной кампании и т.д.)  #task уточнить определение для Разбивки
-  `funnel_steps` - шаги воронки
- для типа Last click также можно указать `priorities` - список названий правил присвоения приоритета? Сами правила прописаны в [[metadata]]  #task уточнить определение
