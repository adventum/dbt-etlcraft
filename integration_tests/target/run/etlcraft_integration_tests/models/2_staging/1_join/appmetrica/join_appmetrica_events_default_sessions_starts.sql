        ...
        insert into test.join_appmetrica_events_default_sessions_starts__dbt_tmp ("__date", "__table_name", "event_datetime", "accountName", "installationDeviceId", "appmetricaDeviceId", "mobileAdsId", "crmUserId", "osName", "cityName", "sessions", "__emitted_at")
  SELECT
