  ...
  create view test.normalize_mt_default_banners__dbt_tmp 
...
JSONExtractString(_airbyte_data, 'urls') AS urls,
    ...
    FROM (
        ...
        (
            select
                cast('test._airbyte_raw_mt_default_maxiretail_banners' as String) as _dbt_source_relation,
            ...
            from test._airbyte_raw_mt_default_maxiretail_banners
        ...
        (
            select
                cast('test._airbyte_raw_mt_default_maxiretail_banners_statistics' as String) as _dbt_source_relation,
            ...
            from test._airbyte_raw_mt_default_maxiretail_banners_statistics
