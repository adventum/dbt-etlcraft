        ...
        insert into test.join_appmetrica_events_default_deeplinks__dbt_tmp ("__date", "accountName", "__table_name", "appmetricaDeviceId", "mobileAdsId", "crmUserId", "osName", "cityName", "adSourceDirty", "utmSource", "utmMedium", "utmCampaign", "utmTerm", "utmContent", "utmHash", "__emitted_at")
  SELECT
