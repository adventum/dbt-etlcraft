        ...
        insert into test.link_appmetrica_registry__dbt_backup ("appmetricaDeviceId", "crmUserId", "cityName", "utmHash", "__emitted_at", "__link", "UtmHashRegistryHash", "AppProfileMatchingHash", "UtmHashHash", "AppMetricaDeviceHash", "CrmUserHash", "__id", "__datetime")
