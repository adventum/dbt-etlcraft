  ...
  create view test.normalize_appmetrica_events_default_profiles__dbt_tmp 
...
JSONExtractString(_airbyte_data, 'profile_id') AS profile_id,
    ...
    FROM (
        ...
        (
            select
                cast('test._airbyte_raw_appmetrica_events_default_3101143_profiles' as String) as _dbt_source_relation,
            ...
            from test._airbyte_raw_appmetrica_events_default_3101143_profiles
