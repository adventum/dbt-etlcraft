  ...
  create view test.normalize_yd_datestat_default_custom_report 
...
JSONExtractString(_airbyte_data, 'Impressions') AS Impressions,
    ...
    FROM (
        ...
        (
            select
                cast('test._airbyte_raw_yd_datestat_default_maxiretail2_custom_report' as String) as _dbt_source_relation,
            ...
            from test._airbyte_raw_yd_datestat_default_maxiretail2_custom_report
