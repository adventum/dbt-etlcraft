  ...
  create view test.normalize_vkads_datestat_default_ad_plans 
...
JSONExtractString(_airbyte_data, 'vkads_status') AS vkads_status,
    ...
    FROM (
        ...
        (
            select
                cast('test._airbyte_raw_vkads_datestat_default_maxi1_ad_plans' as String) as _dbt_source_relation,
            ...
            from test._airbyte_raw_vkads_datestat_default_maxi1_ad_plans
        ...
        (
            select
                cast('test._airbyte_raw_vkads_datestat_default_maxi1_ad_plans_statistics' as String) as _dbt_source_relation,
            ...
            from test._airbyte_raw_vkads_datestat_default_maxi1_ad_plans_statistics
