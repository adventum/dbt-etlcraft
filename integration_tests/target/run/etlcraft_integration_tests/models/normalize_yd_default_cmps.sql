  ...
  create view test.normalize_yd_default_cmps__dbt_tmp 
...
JSONExtractString(_airbyte_data, 'Impressions') AS Impressions,
    ...
    FROM (
        ...
        (
            select
                cast('test._airbyte_raw_yd_default_testaccount_cmps' as String) as _dbt_source_relation,
            ...
            from test._airbyte_raw_yd_default_testaccount_cmps
