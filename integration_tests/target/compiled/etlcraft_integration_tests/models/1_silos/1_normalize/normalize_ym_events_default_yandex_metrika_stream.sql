...
JSONExtractString(_airbyte_data, 'ym:s:visitID') AS ymsvisitID,
    ...
    FROM (
        ...
        (
            select
                cast('test._airbyte_raw_ym_events_default_22222222_yandex_metrika_stream' as String) as _dbt_source_relation,
            ...
            from test._airbyte_raw_ym_events_default_22222222_yandex_metrika_stream
