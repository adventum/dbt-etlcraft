        ...
        insert into test.join_appmetrica_events_install ("__date", "__table_name", "event_datetime", "accountName", "appmetricaDeviceId", "mobileAdsId", "crmUserId", "osName", "cityName", "adSourceDirty", "utmSource", "utmMedium", "utmCampaign", "utmTerm", "utmContent", "utmHash", "installApp", "installs", "__emitted_at", "__link")
  SELECT
